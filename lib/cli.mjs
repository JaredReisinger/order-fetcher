...
const extraHelp = `
  ...
  Examples:
    ...
    ${pkgInfo.name} --after 2018-01-01 --status processing --sku some-sku --out some-sku.csv
...
async function main() {
    ...
    commander
        ...
        .option('--sku <sku>', 'filter to the specific sku, can be given multiple times', collect, [])
        .option('-o, --out <filename>', 'file to write (CSV format)')
        .option('-v, --verbose', 'increase verbosity of logging output, can be given multiple times', increment, 0);
